...
function getPlaces(longitude, latitude, radius, sport){
    ...
    let request = new XMLHttpRequest();
      let url = "https://sportplaces.api.decathlon.com/api/v1/places?origin="+longitude+","+latitude+"&radius="+radius;
      if (sport != ""){
          console.log("ouah");
          url += "&sports="+sport;
      }
      ...
      request.onload = () => {
        ...
        if (request.status === 200) {
          ...
          data.data.features.forEach(element => {
              ...
              let address = new Address(ad.address,ad.postal_code,ad.city,ad.country);
